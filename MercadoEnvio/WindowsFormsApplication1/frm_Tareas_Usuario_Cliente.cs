...
{
    public partial class frm_Tareas_Usuario_Cliente : Form
    {
        public frm_Tareas_Usuario_Cliente()
        {
            InitializeComponent();
        }

        private void frm_Tareas_Usuario_Cliente_Load(object sender, EventArgs e)
        {
